...
- [ ] Check Pi-hole's own docs (and whether a community fork exists) for a real reverse-proxy auth-trust mechanism (header-based or OIDC), as a more robust replacement for disabling its password outright (2026-08-29 entry)
